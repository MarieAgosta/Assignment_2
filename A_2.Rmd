...
We predict that gender and race will be stronger indicators than in previous generations. Minority Millennials compose a large portion of the whole generation, and they have been casting votes at a high enough rate to strongly influence election turnout (@wang2013breadwinner).
 
Additionally, the role women play in social, political, and economic life has changed dramatically through the generations. There are more women in college, more women with degrees, and more women as the sole, or primary breadwinner of the family (@Moms.2016). These shifts, especially the economic ones, have affected how women vote (@iversen2006political). As traditional perceptions and roles have changed, social issues have also come to the forefront.
